                ...
                <div className="mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
                    <div className="rounded-2xl bg-white p-6 sm:p-8 shadow-sm ring-1 ring-slate-200">
                        ...
                        <p className="mt-2 text-slate-600">
                            Klik tombol di bawah untuk mulai mengisi survey.
                        </p>
                        ...
                        <div className="mt-6">
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="w-full inline-flex items-center justify-center rounded-xl bg-blue-600 px-4 py-3 font-semibold text-white shadow hover:bg-blue-700 transition"
                            >
                                Mulai Survey
                            </a>
