            ...
            >
                <img
                    ...
                    onError={(e) => {
                        ...
                        e.target.src =
                            "https://media.istockphoto.com/id/1256765390/id/foto/rawa-pening-danau-dengan-latar-belakang-gunung.jpg?s=612x612&w=0&k=20&c=UoTm7bdZizAnK1fPpKa--9hVZMG7UWnybf3tOnH8q8I=";
                    }}
                />
                {/* Overlay */}
                ...
                <div className="relative z-10 text-center p-6 max-w-4xl space-y-6">
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight">
                        Kampung Wisata Mutiara
                    </h1>
                    <p className="text-xl md:text-2xl font-light">
                        Gerbang Keindahan Alam di Utara Kota Medan. Temukan
                        kedamaian di tengah hutan mangrove dan danau buatan yang
                        memesona.
                    </p>
                    <a
                        href="#attractions"
