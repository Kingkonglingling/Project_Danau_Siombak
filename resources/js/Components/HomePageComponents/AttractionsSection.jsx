    ...
    const attractions = [
        {
            ...
            description:
                "Nikmati ketenangan danau dengan menyewa perahu atau kano. Rasakan hembusan angin segar dan pemandangan hijau.",
            color: "text-sky-600",
        },
        {
            icon: Camera,
            ...
            description:
                "Temukan berbagai sudut pandang memukau, terutama saat matahari terbit dan terbenam. Sempurna untuk pecinta fotografi.",
        ...
        },
        {
            ...
            description:
                "Kampung Wisata Mutiara dikenal memiliki beragam jenis ikan air tawar. Bawa peralatan Anda dan nikmati hobi memancing yang santai.",
            ...
            <section id="attractions" className="py-16 md:py-24 bg-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
                        Kampung Wisata Mutiara menawarkan berbagai aktivitas
                        rekreasi yang cocok untuk keluarga, teman, maupun
                    ...
                    <div className="mt-12 grid gap-8 md:grid-cols-3">
                        {attractions.map((item, index) => (
                            ...
                            >
                                <div
                                    className={`p-4 inline-block rounded-full bg-sky-100 ${item.color}`}
                                >
