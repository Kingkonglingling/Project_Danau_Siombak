...
export default function MapSection() {
    ...
    const directionsUrl = "https://www.google.com/maps/dir/?api=1&destination=Danau+Siombak,+Medan+Marelan";

    return (
        <>
      <section id="location" className="py-16 md:py-24 bg-gray-100">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h2 className="text-base font-semibold tracking-wider text-sky-600 uppercase">Temukan Kami</h2>
                        <h3 className="mt-2 text-3xl md:text-4xl font-extrabold text-gray-900 mb-8">
                            Lokasi Danau Siombak di Peta
                        </h3>
                        ...
                        <div className="rounded-xl overflow-hidden shadow-2xl border-4 border-sky-500">
                            <iframe
                                ...
                                title="Peta Lokasi Danau Siombak"
                                className="w-full"
                            ></iframe>
                        </div>

                        <p className="mt-6 text-lg text-gray-600">
                            Peta di atas menunjukkan lokasi Danau Siombak. Gunakan tombol 'Cek Rute' untuk navigasi.
                        </p>
                    </div>
                </section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
                    ...
                    <p className="mt-4 text-xl font-light opacity-90">
                        Kunjungi Danau Siombak dan rasakan pengalaman berlibur yang damai di tengah alam.
                    </p>
